    ...
    return (
        <main className="min-h-screen bg-white pb-20">
            ...
            <div className="container mx-auto px-4 lg:px-8 -mt-8 relative z-10">
                <div className="max-w-xl mx-auto mb-16 shadow-2xl rounded-xl overflow-hidden">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="input w-full pl-12 h-14 border-none focus:ring-2 focus:ring-indigo-600 bg-white"
                        />
                    </div>
                </div>
