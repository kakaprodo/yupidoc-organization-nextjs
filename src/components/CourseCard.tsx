...
export default function CourseCard({
  ...
  return (
    <Link href={href} className="group relative flex h-full flex-col overflow-hidden border border-base-200 bg-base-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)]">
      ...
      <div className="flex flex-1 flex-col gap-4 p-6">
        <div className="flex flex-col gap-2">
          ...
          <div className={`h-0.75 w-10 rounded-full ${accentColor}`} />
        </div>
